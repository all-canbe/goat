...
ROLE_REGISTRY: dict[RoleType, RoleDefinition] = {
    RoleType.GENERAL: RoleDefinition(
        ...
        allowed_tools=[
            ...
            "execute_command", "agent_spawn", "agent_eval", "agent_list",
    ...
    RoleType.IMPLEMENTER: RoleDefinition(
        ...
        display_name="代码实现",
        allowed_tools=["read_file", "write_file", "search_code", "execute_command",
                       "git_status", "git_diff", "git_log", "git_commit"],
        can_spawn=False,
    ),
    ...
    RoleType.VERIFIER: RoleDefinition(
        ...
        display_name="测试验证",
        allowed_tools=["read_file", "execute_command", "search_code"],
        can_spawn=False,
    ),
