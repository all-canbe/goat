...
class ToolApprovalSystem:
    ...
    def _init_default_rules(self):
        builtin_rules = [
            ...
            {'pattern': 'Bash', 'behavior': 'ask', 'source': 'builtin'},
            {'pattern': 'Write', 'behavior': 'ask', 'source': 'builtin'},
            {'pattern': 'Edit', 'behavior': 'ask', 'source': 'builtin'},
            {'pattern': 'Read', 'behavior': 'allow', 'source': 'builtin'},
            {'pattern': 'Glob', 'behavior': 'allow', 'source': 'builtin'},
            {'pattern': 'Grep', 'behavior': 'allow', 'source': 'builtin'},
        ]
    ...
    def categorize_tool(self, name: str, command: str = "", target_path: str = "") -> ToolCategory:
        ...
        read_tools = {'list_files', 'read_file', 'search_code', 'file_grep', 'glob_search', 'get_file_info', 'git_status', 'git_diff', 'git_log', 'glob', 'grep', 'read'}
        write_tools = {'write_file', 'delete_file', 'move_file', 'copy_file', 'file_edit', 'git_commit', 'apply_diff', 'edit', 'write'}
        shell_tools = {'execute_command', 'bash', 'shell', 'run', 'terminal', 'exec'}
        network_tools = {'web_search', 'web_fetch', 'web_download', 'curl', 'wget'}
        destructive_tools = {'delete_file', 'rm', 'remove', 'delete', 'format', 'reset'}
